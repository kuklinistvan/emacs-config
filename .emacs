...
(eval-after-load 'company
  '(add-to-list
    'company-backends '(company-irony-c-headers company-irony company-cmake company-jedi company-go company-css company-css-html-tags)))
